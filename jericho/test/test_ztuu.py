...
walkthrough = 'ne/examine boulders/ne/n/nw/talk to man/take mask/n/wear fish/wear fur/wear razor/s/take rune/take gores/take implementeers/take zm$100000/se'
solution = walkthrough.split('/')

def test_ztuu():
    env = FrotzEnv("../../TextWorld-baselines/games/ztuu.z5", seed=6)
    env.reset()
    for act in solution:
...
def test_max_score():
    env = FrotzEnv("../roms/ztuu.z5", seed=6)
...
def test_inventory():
    ...
    assert 'Forever Gores' in inv_names
