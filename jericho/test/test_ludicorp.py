...
walkthrough = 's/se/x car/open car/enter car/smell car/x gun/take gun/out/nw/n/e/e/s/e/x ladder/take all/w/s/x well/x footprints/x plants/d/x water/touch water/take water/take fuse/u/n/n/w/s/s/d/ne/x label/put fuse in generator/sw/u/n/w/n'
solution = walkthrough.split('/')

def test_ludicorp():
    env = FrotzEnv("../../TextWorld-baselines/games/ludicorp.z5", seed=6)
    env.reset()
    for act in solution:
...
def test_max_score():
    env = FrotzEnv("../roms/ludicorp.z5", seed=6)
