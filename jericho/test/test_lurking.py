...
# 'sit on chair/turn pc on/login 872325412/password uhlersoth/
walkthrough = 'point at box/point at paper/read paper/read paper/read paper/read paper/read paper/wait/wait/get stone/wait/wait/stand/s/w/open refrigerator/get coke/get carton/open microwave/open carton/put carton in microwave/close microwave/press 5/press 0/press 0/press med/press start/wait/wait/wait/wait/open oven/get carton/e/n/ask hacker about keyring/get food to hacker/ask hacker for masterkey/s/press down arrow/wait/wait/s/open panel/get flashlight/press b button/wait/wait/wait/wait/out/e/get gloves/get crowbar/up/light flashlight/get flask/d/w/w/w/u/s/get container/open container/e/wait/wait/wait/e/e/wait/e/wait/e/break glass with crowbar/get axe/w/cut cord with axe/pour wax/up/get plug/drop plug/get paper/down/enter door/lower ladder/down/down/w/w/n/d/e/enter forklift/turn forklift on/e/e/e/remove junk with forklift/remove junk with forklift/remove junk with forklift/remove junk with forklift/leave forklift'
solution = walkthrough.split('/')

def test_lurking():
    env = FrotzEnv("../../TextWorld-baselines/games/lurking.z3", seed=6)
    print(env.reset())
    for act in solution:
...
def test_max_score():
    env = FrotzEnv("../roms/lurking.z3", seed=6)
