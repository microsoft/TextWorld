...
walkthrough = 'open mailbox/get leaflet/read leaflet/n/e/open window/enter/exit/n/n/u/take egg'

solution = walkthrough.split('/')

def test_zork1():
    env = FrotzEnv("../../TextWorld-baselines/games/zork1.z5", seed=6)
    env.reset()
    for act in solution:
...
def test_max_score():
    env = FrotzEnv("../roms/zork1.z5", seed=6)
