...
walkthrough = 's/e/d/get coin/x barrels/get mug/u/w/w/buy box/get box/w/s/w/n/get lamp/s/e/n/e/s/s/e/get key/x table/get bananas/rub lamp/s/w/n/w/s/s/tip boot/get screwdriver/n/n/n/n/n/get bell/unlock door with key/drop key/n/u/give bananas/build glider/drop screw/get sword'
solution = walkthrough.split('/')

def test_dragon():
    env = FrotzEnv("../../TextWorld-baselines/games/dragon.z5", seed=6)
    env.reset()
    for act in solution:
...
def test_max_score():
    env = FrotzEnv("../roms/dragon.z5", seed=6)
