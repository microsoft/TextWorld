...
play(agent, "./games/levelMedium.ulx", max_step=step_size, nb_episodes=1000, verbose=False)
print("Trained in {:.2f} secs".format(time() - start_time))

print(' =====  Test  ========================================================= ')
agent.test(method='random')
play(agent, "./games/levelMedium.ulx", max_step=step_size)  # Medium level game.
